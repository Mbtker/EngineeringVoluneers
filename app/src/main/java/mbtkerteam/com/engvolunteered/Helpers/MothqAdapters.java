...
public class MothqAdapters extends BaseAdapter {

    private final Context context;
    private ArrayList<String> MyArray;

    // 1
    public MothqAdapters(Context context, ArrayList<String> MyArray) {
    ...
    public View getView(final int position, View convertV, ViewGroup parent) {
        ...
        if (convertV == null) {
            ...
            convertV = layoutInflater.inflate(R.layout.layout_mothq_list, null);
        }
        ...
        CellLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(CellLayout.getContext(), "عرض الفيديو", Toast.LENGTH_LONG).show();
